...
public final class MecanumDrive {
    public static class Params {
        ...
        public double kS = 0.0004311664710471181;
        public double kV = 1.358817463769809;
...
//            if (
//                (t >= timeTrajectory.duration && error.position.norm() < 2 && robotVelRobot.linearVel.norm() < 2)
